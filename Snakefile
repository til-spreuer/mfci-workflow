...
rule noise_robustness:
    input:
        expand(
            ...
            # + "candidate_selection_and_paramsTDBL1TDLBRB/"
...
rule _taxi_tradeoffs:
    input:
        ...
        mf_svd="out/csvs/default/HASHTAXI/flowsTD128/HASHmat_fact/candidate_selection_and_paramsTDBL1TDLBRB/discretizing_method_and_paramsTDP_WALKTDLBRB/harmonic_method_and_paramsTDPINVTDLBRB/lr_method_and_paramsTDSVDTDLBQTrQTCLN16RB/n_bestTD1/n_candidatesTD-1/{metric}.csv",
        mf_ica="out/csvs/default/HASHTAXI/flowsTD128/HASHmat_fact/candidate_selection_and_paramsTDBL1TDLBRB/discretizing_method_and_paramsTDP_WALKTDLBRB/harmonic_method_and_paramsTDPINVTDLBRB/lr_method_and_paramsTDICATDLBQTrQTCLN16RB/n_bestTD1/n_candidatesTD-1/{metric}.csv",
